...
return array(
    ...
    'unionco\\components\\Components' => $vendorDir . '/unionco/components/src/Components.php',
    'unionco\\components\\assetbundles\\Components\\ComponentsAsset' => $vendorDir . '/unionco/components/src/assetbundles/components/ComponentsAsset.php',
    'unionco\\components\\components\\BaseComponent' => $vendorDir . '/unionco/components/src/components/BaseComponent.php',
    'unionco\\components\\components\\ComponentInterface' => $vendorDir . '/unionco/components/src/components/ComponentInterface.php',
    'unionco\\components\\components\\FlexibleContent' => $vendorDir . '/unionco/components/src/components/FlexibleContent.php',
    'unionco\\components\\console\\controllers\\BaseController' => $vendorDir . '/unionco/components/src/console/controllers/BaseController.php',
    'unionco\\components\\controllers\\BaseController' => $vendorDir . '/unionco/components/src/controllers/BaseController.php',
    'unionco\\components\\db\\Table' => $vendorDir . '/unionco/components/src/db/Table.php',
    'unionco\\components\\enum\\Components' => $vendorDir . '/unionco/components/src/enum/Components.php',
    'unionco\\components\\helpers\\ConfigHelper' => $vendorDir . '/unionco/components/src/helpers/ConfigHelper.php',
    'unionco\\components\\migrations\\Install' => $vendorDir . '/unionco/components/src/migrations/Install.php',
    'unionco\\components\\models\\Settings' => $vendorDir . '/unionco/components/src/models/Settings.php',
    'unionco\\components\\records\\ComponentType' => $vendorDir . '/unionco/components/src/records/ComponentType.php',
    'unionco\\components\\services\\Base' => $vendorDir . '/unionco/components/src/services/Base.php',
    'unionco\\components\\services\\Manager' => $vendorDir . '/unionco/components/src/services/Manager.php',
    'unionco\\components\\services\\Page' => $vendorDir . '/unionco/components/src/services/Page.php',
    'unionco\\components\\twigextensions\\ComponentsTwigExtension' => $vendorDir . '/unionco/components/src/twigextensions/ComponentsTwigExtension.php',
    'unionco\\components\\variables\\ComponentsVariable' => $vendorDir . '/unionco/components/src/variables/ComponentsVariable.php',
    'unionco\\craftsyncdb\\SyncDbPlugin' => $vendorDir . '/unionco/craft-sync-db/src/SyncDbPlugin.php',
    'unionco\\craftsyncdb\\assetbundles\\cp\\CpAsset' => $vendorDir . '/unionco/craft-sync-db/src/assetbundles/cp/CpAsset.php',
    'unionco\\craftsyncdb\\console\\controllers\\SyncController' => $vendorDir . '/unionco/craft-sync-db/src/console/controllers/SyncController.php',
    'unionco\\craftsyncdb\\controllers\\SyncController' => $vendorDir . '/unionco/craft-sync-db/src/controllers/SyncController.php',
    'unionco\\craftsyncdb\\models\\Settings' => $vendorDir . '/unionco/craft-sync-db/src/models/Settings.php',
    'unionco\\craftsyncdb\\services\\CpService' => $vendorDir . '/unionco/craft-sync-db/src/services/CpService.php',
    'unionco\\craftsyncdb\\twigextensions\\SyncDbTwigExtension' => $vendorDir . '/unionco/craft-sync-db/src/twigextensions/SyncDbTwigExtension.php',
    'unionco\\syncdb\\LocalCommands' => $vendorDir . '/unionco/syncdb/src/LocalCommands.php',
    'unionco\\syncdb\\SyncDb' => $vendorDir . '/unionco/syncdb/src/SyncDb.php',
    'unionco\\syncdb\\models\\Environment' => $vendorDir . '/unionco/syncdb/src/models/Environment.php',
    'unionco\\syncdb\\models\\MysqlSettings' => $vendorDir . '/unionco/syncdb/src/models/MysqlSettings.php',
    'unionco\\syncdb\\models\\PgsqlSettings' => $vendorDir . '/unionco/syncdb/src/models/PgsqlSettings.php',
    'unionco\\syncdb\\models\\Settings' => $vendorDir . '/unionco/syncdb/src/models/Settings.php',
    'unionco\\syncdb\\util\\Command' => $vendorDir . '/unionco/syncdb/src/util/Command.php',
    'unionco\\syncdb\\util\\Util' => $vendorDir . '/unionco/syncdb/src/util/Util.php',
